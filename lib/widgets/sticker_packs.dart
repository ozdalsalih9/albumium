...
String albumStickerAssetPath(String value) {
  final path = value.substring(_assetPrefix.length);
  // Albums persist sticker identifiers. Keep projects created before the
  // WebP optimization readable without rewriting their saved JSON.
  if (path.endsWith('_keepsake.png')) {
...
double albumStickerAspectRatio(String value) {
  if (isAlbumStickerAsset(value)) {
    return switch (albumStickerAssetPath(value)) {
      ...
      'assets/stickers/celestial_keepsake.webp' => .96,
      'assets/stickers/romance_keepsake.webp' => 1.16,
      'assets/stickers/photo_keepsake.webp' => 1.09,
      'assets/stickers/cafe_keepsake.webp' => 1.16,
      'assets/stickers/friendship_keepsake.webp' => 1.09,
      'assets/stickers/cozy_reading_keepsake.webp' => 1.08,
      _ => 1,
    };
  }
...
String albumStickerLabel(String value) {
  ...
  return switch (normalized) {
    ...
    'albumium_asset:assets/stickers/botanical_keepsake.webp' =>
      'Botanik hatıra buketi',
    'albumium_asset:assets/stickers/celestial_keepsake.webp' =>
      'Gece göğü hatırası',
    'albumium_asset:assets/stickers/travel_keepsake.webp' =>
      'Vintage seyahat hatırası',
    'albumium_asset:assets/stickers/romance_keepsake.webp' =>
      'Kadife romantik hatıra',
    'albumium_asset:assets/stickers/photo_keepsake.webp' =>
      'Analog fotoğraf hatırası',
    'albumium_asset:assets/stickers/music_keepsake.webp' =>
      'Retro müzik hatırası',
    'albumium_asset:assets/stickers/sewing_keepsake.webp' =>
      'Dikiş sepeti hatırası',
    'albumium_asset:assets/stickers/celebration_keepsake.webp' =>
      'Diskolu kutlama hatırası',
    'albumium_asset:assets/stickers/seaside_keepsake.webp' => 'Sahil hatırası',
    'albumium_asset:assets/stickers/cafe_keepsake.webp' =>
      'Nostaljik kafe hatırası',
    'albumium_asset:assets/stickers/friendship_keepsake.webp' =>
      'Arkadaşlık bilekliği hatırası',
    'albumium_asset:assets/stickers/cozy_reading_keepsake.webp' =>
...
const stickerPacks = <StickerCategory>[
  StickerCategory(
    ...
    stickers: [
      ...
      'albumium_asset:assets/stickers/sewing_keepsake.webp',
      'albumium_asset:assets/stickers/celebration_keepsake.webp',
      'albumium_asset:assets/stickers/seaside_keepsake.webp',
      'albumium_asset:assets/stickers/cafe_keepsake.webp',
      'albumium_asset:assets/stickers/friendship_keepsake.webp',
      'albumium_asset:assets/stickers/cozy_reading_keepsake.webp',
    ],
