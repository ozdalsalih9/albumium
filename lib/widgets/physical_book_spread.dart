...
class PhysicalBookSpread extends StatelessWidget {
  ...
  Widget _buildFocusedEditor({
    ...
    // Tek/son sayfada karşı yaprak yoksa cildin ötesinde boş bir kâğıt şeridi
...
class _CurlingLeaf extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final turn = progress.clamp(0.0, 1.0);
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        Widget curl = Stack(
          ...
          children: [
            curlSurface(
              key: const ValueKey('book-page-curl-front'),
              page: front,
