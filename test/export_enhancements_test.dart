...
void main() {
  group('Export enhancements verification', () {
    test(
      '5-page album storyboard duration is ~15-16 seconds with gentle pacing',
      () {
    ...
    test(
      'video export quality has distinct bitrate and profile expectations',
      () {
    ...
    test(
      'photo crop editor peekLoadedAlbumPhoto returns null for unknown path safely',
      () {
